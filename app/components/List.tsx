...
import { Accordion, Container, Anchor } from "@mantine/core";
        ...
        <ListItem
          ...
          description={
            <>
              ...
              here</Anchor>. According to the
              <Anchor target="_blank" href="https://github.com/lorencerri/play-doom#play-doom">stats</Anchor>, over
